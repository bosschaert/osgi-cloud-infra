...
java $JAVA_OPTS -Dcom.sun.management.jmxremote.port=9999 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dorg.ops4j.pax.web.listening.addresses=$OPENSHIFT_GEAR_DNS -jar org.eclipse.osgi_3.7.2.v20120110-1415.jar -configuration config-local -clean 
